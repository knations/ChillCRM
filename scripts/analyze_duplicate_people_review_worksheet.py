...
def generate_report(rows: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        "This is a read-only working packet for duplicate-person cleanup review. It does not save the project policy, save group decisions, merge records, delete records, resolve cleanup flags, or update Zendesk Sell.",
        "",
        "## Summary",
        "",
