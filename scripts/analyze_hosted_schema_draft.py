...
def generate_report(rows: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "- Included in the Complete CRM Package.",
        ...
        *table(
        ...
        "## Safety Boundary",
        "",
        "This schema draft is an artifact for staging review only. It does not connect to a remote host, does not create tables anywhere, does not migrate data, does not invite users, and does not alter the CHILLCRM.",
        "",
        "## Related Files",
        "",
