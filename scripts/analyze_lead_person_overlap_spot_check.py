...
def generate_report(rows: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        "Use this report as the focused evidence page before saving the Lead/person overlap policy. It is read-only and does not save the project decision, merge records, delete records, resolve cleanup flags, or update legacy CRM provider.",
        "",
        "## Summary",
        "",
        ...
        *table(
        ...
        "",
        "- People are the natural ongoing client records in the CHILLCRM.",
