...
def generate_report(rows: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        "This is a read-only permissions and rollout plan for moving the CHILLCRM into a shared remote system for you and admins. It does not create users, expose localhost, provision hosting, migrate data, save decisions, or change CRM records.",
        "",
        "## Summary",
        "",
