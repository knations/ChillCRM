...
def generate_report(rows: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        *table(
        ...
        "## Recommendation",
        "",
        "Choose option A unless you specifically want to operate server infrastructure yourself. Option A keeps the project pointed at a secure hosted app with managed database, private files, individual logins, staging, backups, and audit controls while preserving the CHILLCRM as source of truth until cutover.",
        "",
        "## Safety Boundary",
        "",
        "This packet is planning only. It does not choose a provider, provision hosting, create a remote database, upload files, create users, invite admins, save decisions, expose this machine, or change CHILLCRM records.",
        "",
        "## Related Files",
        "",
