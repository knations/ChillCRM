...
def generate_report(rows: list[dict[str, Any]], grouped_rows: list[dict[str, Any]], phone_key_count: int) -> str:
    ...
    lines = [
        ...
        *table(
        ...
        "- Use the CHILLCRM Archive Manual Review Queue to work the remaining items in small batches and mark review status before linking anything.",
        ...
        "- If a specific item is identified by human review, use the Archive row inspector in the CHILLCRM to link it manually; that action creates a backup and audit entry before changing the archive item.",
