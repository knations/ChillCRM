...
SECRET_PATTERNS = [
    ...
    SecretPattern(
        ...
        re.compile(
            ...
            r"CHILLCRM_APP_USER_PASSWORD|CHILLCRM_ZAPIER_WEBHOOK_SECRET|CHILLCRM_AUTOMATION_TOKEN|GRANOLA_API_KEY|DATABASE_URL|SUPABASE_ACCESS_TOKEN|SUPABASE_SERVICE_ROLE_KEY|SERVICE_ROLE_KEY|VERCEL_TOKEN)"
            r"\s*=\s*([^\s`'\"<>][^\s`'\"]{8,})"
        ),
    ),
]
